...
end_page = 34 # 끝 페이지 번호
minimum_price = 10000  # 최소 가격 설정
use_login = False  # 로그인 사용 여부
login_url = ''  # 로그인 페이지 URL (로그인 불필요)
catalog_url_template = 'https://starsportsmall.co.kr/goods/submain_new.asp?page={page}&cate=0&sword=&swhat=&listsort=new&listtype=album&listsize=20&sprice='  # 카탈로그 페이지 URL 템플릿
product_base_url = 'https://starsportsmall.co.kr'  # 제품 페이지 베이스 URL
base_url2= 'https://starsportsmall.co.kr/goods/'  # (필요시만 사용) 2차 이동시 썸네일이나 상세페이지 주소를 위한 도메인
login_credentials = {
    'userid': '',
    'password': ''
}
