...
with sync_playwright() as p:
    ...
    try:
            ...
            for product in product_names:
                ...
                try:
                    ...
                    if adjusted_price >= minimum_price:
                        pass
                        # print(f"가격: {adjusted_price}")  # 주석 처리
                ...
                if thumbnail_element:
                    ...
                    # print(f"썸네일 URL: {thumbnail_url}")  # 주석 처리
                ...
                try:
                    ...
                    logging.error(f"썸네일 이미지 처리 중 오류 발생: {e}")  # 로그로 대체
                ...
                try:
                        ...
                        try:
                            ...
                            if image_element:
                                ...
                                if image_url and not image_url.endswith('.png') and "https://sysheen.speedgabia.com/internet_dept/b2b/01_common/ExchangeReturn_info.jpg" not in image_url:
                                    ...
                                    logging.info(f"Invalid image URL skipped: {image_url}")  # 로그로 대체
                            else:
                                logging.info(f"No image element found for index {p}")  # 로그로 대체
                        except AttributeError as e:
                            logging.error(f"AttributeError: {e}")  # 로그로 대체
                    ...
                    #     print(f"상세 이미지 URL: {img_url}")  # 주석 처리
                    # if product_details:
                    #     print("상품 세부 정보:")
                    #     for key, value in product_details.items():
                    #         print(f"{key}: {value}")  # 주석 처리
                    ...
                    logging.error(f"상세 페이지 이미지 처리 중 오류 발생: {e}")  # 로그로 대체
                ...
                # print(f"옵션: {option_string if option_string else '옵션 없음'}")  # 주석 처리
        ...
        logging.error(f"오류 발생: {e}")  # 로그로 대체
